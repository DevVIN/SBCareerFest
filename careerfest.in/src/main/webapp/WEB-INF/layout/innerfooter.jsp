...
<footer class="bg-white builder-bg footer-style8 padding-60px-tb xs-padding-40px-tb text-center">
    <a href="jobseekerLanding.html" target="_blank" title="About Us">About Us</a>
    ...
    <p>All rights reserved © 2018 CareerFest</p>            
</footer>