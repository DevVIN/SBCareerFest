            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="mail">GET SUPPORT: <a href="mailto:mycareer@careerfest.in" class="text-light-gray tz-text">MYCAREER@CAREERFEST.IN</a></div>
                        <!-- social elements -->
            ...
            <div class="container navigation-menu">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-9">
                        <a href="#home" class="inner-link mainlogo">
                            <img alt="" src="images/logo.svg" data-img-size="(W)163px X (H)39px">
                        </a>
                    </div>
                    <!-- end logo -->
                ...
                <form role="form">
                    <div class="form-group row">
                        <div class="col-md-4 col-sm-4 col-xs-12 keyword-container">
                            <input type="text" class="form-control" placeholder="Skills, Designations, Companies"/>
                        </div>
                        <div class="col-md-2 col-sm-4 col-xs-12 loc-container">
                            <input type="text" class="form-control" placeholder="Location/Locality"/>
                        </div>
...
<section id="home" class="no-padding slider-style1 border-none">
    <div class="owl-slider-full owl-carousel owl-dark-pagination owl-without-next-pre-arrow">
        <!-- slider item -->
        <div class="item owl-bg-img tz-builder-bg-image cover-background bg-img-one" id="tz-bg-1" data-img-size="(W)1920px X (H)994px" style="background: linear-gradient(rgba(15, 15, 15, 0.0), rgba(15, 15, 15, 0.0)) repeat scroll 0% 0%, transparent url('images/bg-image/agency-slider-01.jpg') repeat scroll 0% 0%;">
        ...
        <!-- end slider item -->
        <!-- slider item -->
        <div class="item owl-bg-img tz-builder-bg-image cover-background bg-img-two" id="tz-bg-2" data-img-size="(W)1920px X (H)994px" style="background: linear-gradient(rgba(15, 15, 15, 0.0), rgba(15, 15, 15, 0.0)) repeat scroll 0% 0%, transparent url('images/bg-image/agency-slider-02.jpg') repeat scroll 0% 0%;">
            <div class="container one-third-screen xs-one-second-screen position-relative">
                    ...
                    <div class="slider-text-middle-main">
                        <div class="slider-text-middle">
                            <div class="col-md-7 col-sm-12 col-xs-12 no-padding alt-font slider-content sm-no-margin-top">
                                <div class="title-extra-large-6 line-height-75 font-weight-700 text-light-purple-blue slider-title margin-seven-bottom tz-text letter-spacing-minus-1">FIND BETTER JOBS WITH CAREERFEST</div>
                                <div class="btn-dual">
        ...
        <!-- end slider item -->
        <!-- slider item -->
        <div class="item owl-bg-img tz-builder-bg-image cover-background bg-img-three" id="tz-bg-3" data-img-size="(W)1920px X (H)994px" style="background: linear-gradient(rgba(15, 15, 15, 0.0), rgba(15, 15, 15, 0.0)) repeat scroll 0% 0%, transparent url('images/bg-image/agency-slider-03.jpg') repeat scroll 0% 0%;">
            <div class="container one-third-screen xs-one-second-screen position-relative">
                <div class="col-md-12 col-sm-12 col-xs-12 slider-typography text-left sm-position-inherit">
                    <div class="slider-text-middle-main">
                        <div class="slider-text-middle"> 
                            <div class="col-md-7 col-sm-12 col-xs-12 no-padding alt-font slider-content sm-no-margin-top">
                                <div class="title-extra-large-6 line-height-75 font-weight-700 text-light-purple-blue slider-title margin-seven-bottom tz-text letter-spacing-minus-1" id="tz-slider-text9">UPGRADE YOUR SKILLS</div>
                                <div class="btn-dual">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12 xs-margin-fifteen-bottom">
                <div class=" display-table margin-five-bottom width-100">
                    ...
                    <div class="display-table-cell-vertical-middle ">
                        <h3 class="text-large alt-font text-dark-gray position-relative top-minus3 tz-text">Updated Resume Ensures You Find Better</h3>
                    </div>
                </div>
                <div class="text-medium width-95 xs-width-100 xs-margin-five-top tz-text"><p class="no-margin-bottom">Your profile is the key to making CareerFest work harder for you. The more you tell us about yourself, the more opportunities you'll have to take advantage of our many tools and services.</p></div>
            </div>
            <!-- end feature box -->
            <!-- feature box -->
            <div class="col-md-4 col-sm-4 col-xs-12 xs-margin-fifteen-bottom">
                <div class=" display-table margin-five-bottom width-100">
                    ...
                    <div class="display-table-cell-vertical-middle ">
                        <h3 class="text-large alt-font text-dark-gray position-relative top-minus3 tz-text">Find Better Jobs with Careerfest</h3>
                    </div>
                </div>
                <div class="text-medium width-95 xs-width-100 xs-margin-five-top tz-text"><p class="no-margin-bottom">Your profile is used to provide job offers and recommendations that are customized to meet your career needs. It is always recommended to also have a visible resume for employers to find.</p></div>
            </div>
            <!-- end feature box -->
            <!-- feature box -->
            <div class="col-md-4 col-sm-4 col-xs-12 xs-margin-fifteen-bottom">
                <div class=" display-table margin-five-bottom width-100">
                    ...
                    <div class="display-table-cell-vertical-middle ">
                        <h3 class="text-large alt-font text-dark-gray position-relative top-minus3 tz-text">Upgrade Your Skills</h3>
                    </div>
                </div>
                <div class="text-medium width-95 xs-width-100 xs-margin-five-top tz-text"><p class="no-margin-bottom">Try to keep your profile up to date. If there are changes to your career, interests, education, or other details in your profile, remember to update your information to keep the personalized services coming.</p></div>
            </div>
            <!-- end feature box -->
        </div>
    </div>
...
<section class="padding-110px-tb xs-padding-60px-tb bg-light-gray builder-bg border-none" id="content-section13">
    <div class="container">
        <div class="row equalize xs-equalize-auto equalize-display-inherit">
            <!-- content details -->
            <div class="col-md-12 col-sm-12 xs-12 xs-text-center xs-margin-nineteen-bottom display-table">
                <div class="display-table-cell-vertical-middle">
                    <h2 class="section-title-large sm-section-title-medium xs-section-title-large text-dark-gray font-weight-700 alt-font margin-three-bottom xs-margin-fifteen-bottom tz-text">About</h2> 
                    <div class="text-medium tz-text width-90 sm-width-100"><p>CareerFest India, India's leading online career and recruitment resource with its cutting edge technology provides relevant profiles to employers and relevant jobs to jobseekers across industry verticals, experience levels and geographies. More than 200 million people have registered on the CareerFest Worldwide network. Today, with operations in more than 40 countries, CareerFest provides the widest and most sophisticated job seeking, career management, recruitment and talent management capabilities globally. CareerFest India started its operations in 2018. Headquartered in Pune, the company has presence in 4 other cities of India viz., Mumbai, Delhi, Hyderabad, Kolkata.</p></div>
    ...
    <div class="container">
        <div class="row equalize">
            <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                <div class="display-inline-block sm-display-block vertical-align-middle margin-five-right sm-no-margin-right sm-margin-ten-bottom tz-text alt-font text-white title-medium sm-title-medium">Put your career in top gear with our career services</div>
    ...
    <div class="container-fluid">
        <div class="row four-column">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 padding-six no-padding-tb sm-margin-nine-bottom xs-margin-fifteen-bottom">
                ...
                <h3 class="text-dark-gray text-extra-large alt-font display-block tz-text">Top Jobs</h3>
                <div class="text-medium tz-text"><p>Careerfest will provide you the top jobs opportunities in india for IT/Software profestionals, Marketing etc.</p></div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 padding-six no-padding-tb sm-margin-nine-bottom xs-margin-fifteen-bottom">
                ...
                <h3 class="text-dark-gray text-extra-large alt-font display-block tz-text">Walkin Jobs</h3>
                <div class="text-medium tz-text"><p>Careerfest will provide you Walkin job opportunities in india for IT/Software profestionals, Marketing etc.</p></div>
                <div class="separator-line2 bg-greenish-blue margin-twenty-top tz-background-color"></div>
            </div>
            <!-- end feature box -->
            <!-- feature box -->
            <div class="col-md-3 col-sm-6 col-xs-12 padding-six no-padding-tb sm-margin-nine-bottom xs-margin-fifteen-bottom">
                ...
                <h3 class="text-dark-gray text-extra-large alt-font display-block tz-text">Contract Jobs</h3>
                <div class="text-medium tz-text"><p>Careerfest will provide you Contract job opportunities in india for IT/Software profestionals, Marketing etc.</p></div>
                <div class="separator-line2 bg-greenish-blue margin-twenty-top tz-background-color"></div>
            </div>
            <!-- end feature box -->
            <!-- feature box -->
            <div class="col-md-3 col-sm-6 col-xs-12 padding-six no-padding-tb sm-margin-nine-bottom xs-margin-fifteen-bottom">
                ...
                <h3 class="text-dark-gray text-extra-large alt-font display-block tz-text">Government Jobs</h3>
                <div class="text-medium tz-text"><p>Careerfest will provide you Government jobs opportunities in india for Freshers</p></div>
                <div class="separator-line2 bg-greenish-blue margin-twenty-top tz-background-color"></div>
            </div>
            <!-- end feature box -->
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7 col-md-8 col-sm-12 col-xs-12 center-col text-center">
                <h2 class="alt-font text-white font-weight-500 title-extra-large-2 line-height-50 sm-section-title-large xs-section-title-large sm-no-margin-top margin-six-bottom sm-margin-five-bottom tz-text">Introduce <br>your self or company</h2>
                <div class="title-medium sm-title-medium xs-title-medium text-white width-85 sm-width-100 center-col font-weight-100 margin-six-bottom sm-margin-five-bottom tz-text">Since our foundation in 2018 our goal has been to use digital technology to create Jobs.</div>
                ...
                <div class="item">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="client-logo-outer">
                            <div class="client-logo-inner">
                                <a href="#">
                                    <img src="images/clients-6.jpg" id="tz-bg-154" data-img-size="(W)800px X (H)500px" alt="">
                                </a>
                            </div>
                        </div>
                    </div>                               
                ...
                <div class="item">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="client-logo-outer">
                            <div class="client-logo-inner">
                                <a href="#">
                                    <img src="images/clients-7.jpg" id="tz-bg-155" data-img-size="(W)800px X (H)500px" alt="">
                                </a>
                            </div>
                        </div>
                    </div>                               
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                ...
                <div class="text-medium width-60 margin-lr-auto md-width-70 sm-width-100 tz-text margin-thirteen-bottom xs-margin-nineteen-bottom">Put Your Career in Gear with Our Career Services</div>
            </div>
            <!-- end section title -->
        </div>
        <div class="row three-column">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 margin-three-bottom xs-margin-ten-bottom">
                ...
                <h3 class="text-medium font-weight-600 text-dark-gray overflow-hidden vertical-align-middle line-height-30 tz-text">Xpress Resume</h3>
                <div class="text-medium width-95 margin-nine-top xs-width-100 xs-margin-five-top tz-text"> <p>By XPRESSResume+ you can Share Your Resume with Top Consultants & Expedite your Job Hunt . </p> </div>
            </div>
            <!-- end feature box -->
            <!-- feature box -->
            <div class="col-md-4 col-sm-6 col-xs-12 margin-three-bottom xs-margin-ten-bottom">
                ...
                <h3 class="text-medium font-weight-600 text-dark-gray overflow-hidden vertical-align-middle line-height-30 tz-text">Right Resume</h3>
                <div class="text-medium width-95 margin-nine-top xs-width-100 xs-margin-five-top tz-text"> <p> Get right Resume for a great impression with a Professionally written resume</p> </div>
            </div>
            <!-- end feature box -->
            <!-- feature box -->
            <div class="col-md-4 col-sm-6 col-xs-12 margin-three-bottom xs-margin-ten-bottom">
                ...
                <h3 class="text-medium font-weight-600 text-dark-gray overflow-hidden vertical-align-middle line-height-30 tz-text">Career Booster</h3>
                <div class="text-medium width-95 margin-nine-top xs-width-100 xs-margin-five-top tz-text"> <p> Right Resume(Professionally Written Resume) + Xpress Resume+(Share with Top Consultants)</p> </div>
            </div>
            <!-- end feature box -->
            <!-- feature box -->
            <div class="col-md-4 col-sm-6 col-xs-12 xs-margin-ten-bottom">
                ...
                <h3 class="text-medium font-weight-600 text-dark-gray overflow-hidden vertical-align-middle line-height-30 tz-text"> Resume Highlighter </h3>
                <div class="text-medium width-95 margin-nine-top xs-margin-five-top tz-text"> <p>Get noticed by the recruiters by Highlighting skills on resume.Get Resume Highlighter Now.</p> </div>
            </div>
            <!-- end feature box -->
            <!-- feature box -->
            <div class="col-md-4 col-sm-6 col-xs-12 xs-margin-ten-bottom">
                ...
                <h3 class="text-medium font-weight-600 text-dark-gray overflow-hidden vertical-align-middle line-height-30 tz-text">IACT</h3>
                <div class="text-medium width-95 margin-nine-top xs-margin-five-top tz-text"> <p> International Academy for Certification & Training programmes</p> </div>
            </div>
            <!-- end feature box -->
            <!-- feature box -->
            <div class="col-md-4 col-sm-6 col-xs-12">
                ...
                <h3 class="text-medium font-weight-600 text-dark-gray overflow-hidden vertical-align-middle line-height-30 tz-text">AMCAT</h3>
                <div class="text-medium width-95 margin-nine-top xs-margin-five-top tz-text"> <p>More than 1,50,000 interview calls sent every month based on AMCAT scores</p> </div>
            </div>
            <!-- end feature box -->
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                ...
                <div class="text-medium width-60 margin-lr-auto md-width-70 sm-width-100 tz-text margin-thirteen-bottom xs-margin-nineteen-bottom">Career Advice by most Experts in the industry</div>
            </div>
            <!-- end section title -->
        </div>
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12 text-center xs-margin-fifteen-bottom">
                <div class="team position-relative bg-white tz-background-color">
                    <img alt="" src="images/team-01.jpg" data-img-size="(W)750px X (H)893px" class="margin-twelve-bottom">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12 text-center xs-margin-fifteen-bottom">
                <div class="team position-relative bg-white tz-background-color">
                    <img alt="" src="images/team-02.jpg" data-img-size="(W)750px X (H)893px" class="margin-twelve-bottom">
                    <div class="team-details text-center">
                        <div class="team-name padding-twelve-bottom margin-twelve-bottom border-bottom tz-border">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12 text-center xs-margin-fifteen-bottom">
                <div class="team position-relative bg-white tz-background-color">
                    <img alt="" src="images/team-03.jpg" data-img-size="(W)750px X (H)893px" class="margin-twelve-bottom">
                    <div class="team-details text-center">
                        <div class="team-name padding-twelve-bottom margin-twelve-bottom border-bottom tz-border">
            ...
            <div class="testimonial-style3 owl-carousel owl-theme owl-dark-pagination owl-pagination-bottom">
                ...
                <div class="item">
                    <div class="col-md-12 col-sm-12 col-xs-12 xs-no-padding-15 text-center">
                        ...
                        <div class="text-medium margin-six-bottom tz-text width-95 sm-width-100 center-col" id="tz-slider-text94">It was awesome feeling when you get your first job, that feeling given by Careerfest</div>
                ...
                <div class="item">
                    <div class="col-md-12 col-sm-12 col-xs-12 xs-no-padding-15 text-center">
                        ...
                        <div class="text-medium margin-six-bottom tz-text width-95 sm-width-100 center-col" id="tz-slider-text96">It was me who did updated wrong resume but Careerfest did it for me</div>
                ...
                <div class="item">
                    <div class="col-md-12 col-sm-12 col-xs-12 xs-no-padding-15 text-center">
                        ...
                        <div class="text-medium margin-six-bottom tz-text width-95 sm-width-100 center-col" id="tz-slider-text98">3 Biggest Biggest opportunities given by Carrerfest that all paidoff</div>
                ...
                <div class="item">
                    <div class="col-md-12 col-sm-12 col-xs-12 xs-no-padding-15 text-center">
                        ...
                        <div class="text-medium margin-six-bottom tz-text width-95 sm-width-100 center-col" id="tz-slider-text100">It was me who did updated wrong resume but Careerfest did it for me</div>
                ...
                <div class="item">
                    <div class="col-md-12 col-sm-12 col-xs-12 xs-no-padding-15 text-center">
                        ...
                        <div class="text-medium margin-six-bottom tz-text width-95 sm-width-100 center-col" id="tz-slider-text102">It was awesome feeling when you get your first job, that feeling given by Careerfest</div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 xs-margin-fifteen-top">
                <div class="padding-eighteen no-padding-top no-padding-bottom xs-no-padding">
                    <h2 class="alt-font text-dark-gray title-large display-block xs-title-extra-large-2 tz-text margin-nine-bottom width-90 md-width-100">Looking For a Excellent Career opportunities?</h2>
                    <div class="text-medium tz-text margin-ten-bottom">Put Your Career in Gear with Our Career Services</div>
                    ...
                    <div class="contact-details padding-eighteen-top border-top">                                
                        ...
                        <p class="text-medium tz-text">301 The CareerFest,<br>Pune, 411045</p>
                        <p class="text-medium tz-text no-margin-bottom">+91 (0) 8007477707</p>
                        <a href="mailto:mycareer@careerfest.in" class="text-dark-gray text-decoration-underline text-medium tz-text no-margin-bottom">mycareer@careerfest.in</a>
                    </div>
                </div>
            </div>
            <!-- end contact details -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-sm-12 col-xs-12 sm-text-center sm-margin-five-bottom ">
                ...
                <!-- end logo -->
                <div class="tz-text width-80 sm-width-100"><p class="no-margin-bottom">Increase your chances of receiving relevant jobs from recruiters. Apply to jobs on the go Discover connections who can refer you for jobs Exclusively on CareerFest</p></div>
            </div>
            <!-- links -->
        ...
        <div class="row equalize">
            <div class="border-top margin-five-top padding-five-top tz-border">
                <div class="col-md-6 col-sm-6 col-xs-12 display-table xs-text-center xs-margin-nine-bottom">
                    <div class="display-table-cell-vertical-middle">
                        <span class="tz-text text-small">© 2018 CareerFest is Proudly Powered By <a class="text-light-gray2" href="#">TwoPointsTechy</a></span>
                    </div>
                </div>
